...
//        System.out.println("---- I am inside Login Sauce site POM----");
...
//        // conditii cu LoginPage
//        login = new LoginPage(driver);
//        login.enterUsername(username);
//        login.enterPassword(password);
//
//        //        conditii fara LoginPage
...
//        WebElement productsTitle = login.checkProductIsDisplayed();
